...
## 2026-03-01 — Calendar Details

Calendar task rows (`TaskRow`) now natively act as buttons. Clicking any task in the calendar opens a top-level modal containing the reusable `PostCard` component. This allows Loopers to instantly view full details or apply directly from the calendar, and Inners to quickly access or edit their scheduled tasks.
